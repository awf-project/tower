...
| [user-guide/debug-sessions.md](user-guide/debug-sessions.md) | How to configure and drive interactive Debug Adapter Protocol sessions with `tower_debug_*` tools |
...
| [mcp-tools.md](mcp-tools.md) | Wire protocol, session lifecycle, the native `tower_*` tools, extension tools (`tower_ast_get_outline`, `tower_lint_check`, `tower_lint_fix`, `tower_debug_launch`, …), JSON-RPC error codes |
