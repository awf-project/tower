...
| [mcp-tools.md](mcp-tools.md) | Wire protocol, session lifecycle, all 7 native `vfs_*` tools, AST plugin tools (`ast/ast_get_outline`, `ast/ast_find_symbols`), JSON-RPC error codes |
